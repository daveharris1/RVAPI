namespace RVApiHandler.Urls
{
    public class ApiUrls
    {
        public const string YouTubeUrl = "https://www.googleapis.com/youtube/v3/playlistItems?part=snippet&playlistId=UU4zI_p-bpLxUMBt37Ypeo3Q&key=AIzaSyBZcpN-XiPVCvqGDZXJqw-rAoqxNUvLSdY";
